...
function ShoppingListing() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 p-4 md:p-6 flex-grow">
      <ProductFilter filters={filters} handleFilter={handleFilter} resetPage={resetPage}/>
